...
export function getStories() {
  ...
  const storyFiles = [
    ...
    { id: 3, filename: 'thanos-protocal.md', title: 'thanos protocal' },
    { id: 4, filename: 'midnight-chorus.md', title: 'midnight chorus' },
    { id: 5, filename: 'paper-wings.md', title: 'paper wings' },
    { id: 6, filename: 'the-last-garden.md', title: 'the last garden' },
  ];
