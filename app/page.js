              ...
              {stories.map((story) => (
                ...
                >
                  <div className="w-[50px] h-[50px] rounded-full border border-black relative overflow-hidden flex items-center justify-center">
                    ...
                    {/* Dot for mobile that expands on tap */}
                    <div className="relative z-10 w-1 h-1 rounded-full bg-black lg:hidden active:w-full active:h-full transition-all duration-300 ease-out"></div>
                    {/* Arrow for desktop */}
